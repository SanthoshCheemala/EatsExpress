...
export const HomePage = () => {
  return (
    <div className="flex flex-col gap-12">
        <div className="flex flex-col gap-4 py-8 -mt-16 text-center bg-white rounded-lg shadow-md">
        ...
        <div className="grid gap-5 md:grid-cols-2">
            ...
            <div className="flex flex-col items-center justify-center gap-4 text-center">
                ...
                <span className="">
                    Download the FastExpress app for faster ordering and personalised recommendations
                </span>
